import { getFeaturedBannerPost, getFeaturedBannerPostDetails } from "../../services";
...
<meta property="og:url" content={`https://kadınhastalıkları.com/${post.slug}`}/>
...
<meta property="og:image" content="http://graphics8.nytimes.com/images/2011/12/08/technology/bits-newtwitter/bits-newtwitter-tmagArticle.jpg" />
    ...
    <span >
      ...
      <span>
      <Link href={`http://twitter.com/share?text=Mutlaka okuyun... &url=https://kadınhastalıkları.com/${post.slug}`}>
 
                 <img src=".././twitter.png" width="30px" height="" />
      </Link>
      </span>
      <span>
      <Link  href={`https://wa.me/?text=https://kadınhastalıkları.com/${post.slug}`}>
...
export async function getStaticProps({ params }) {
  const data = await getFeaturedBannerPostDetails(params.slug);
  return {
    props: { post: data },
  };
}
...
export async function getStaticPaths() {
  const posts = await getFeaturedBannerPost();
  return {
